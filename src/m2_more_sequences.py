...
def shortest_string(strings):
    ...
    # ------------------------------------------------------------------
    minimum_string = strings[0]
    for k in range(len(strings)):
        if len(strings[k]) < len(minimum_string):
            minimum_string = strings[k]
    return minimum_string

    # minimum_index = 0
    # for k in range(len(strings)):
    #     if len(strings[k]) < len(strings[minimum_index]):
    #         minimum_index = k
    # return strings[minimum_index]
...
def number_of_stutters(s):
    ...
    # ------------------------------------------------------------------
    count = 0
    first_letter_stored = s[0]
    for k in range(len(s)-1):
        if first_letter_stored == s[k+1]:
            count += 1
        first_letter_stored = s[k+1]
    return count
